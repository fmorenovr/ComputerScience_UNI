...
appControllers.controller('cifradoController', ['$scope',function($scope) {
  ...
  $scope.messageKey = "10"
  $scope.messageEncrypt = "FELIPE MORENO 20120354I"
  ...
  $scope.cifrarMensaje = function(){
    var aux
//    for(var i=0; i<parseInt($scope.messageKey);i++){
      //aux=$scope.messageEncrypt+i
      aux=$scope.messageEncrypt
      $scope.messageDecrypt = SHA_1(aux)
      console.log("mensaje: "+aux)
      console.log("cifrado: "+$scope.messageDecrypt)
      /*if($scope.messageDecrypt[0]=="0" && $scope.messageDecrypt[1]=="0"){
        alert("Numero encontrado en la iteracion: "+i)
        return
      }
    }*/
  }
