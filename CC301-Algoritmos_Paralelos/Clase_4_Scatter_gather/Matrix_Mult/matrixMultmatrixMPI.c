...
#define NRA 3                 /* # de filas de matrix A */
#define NCA 3                /* # de columnas de matrix A */
#define NCB 3                  /* # de conlumnas in matrix B */
...
/**************************** master task ************************************/
  if (rank == MASTER)
  {
    printf("mpi_mm se inicializa con %d procesos copia.\n",size);
