...
public class Visualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String codigo = request.getParameter("codigo");
        ...
        emf = Persistence.createEntityManagerFactory("Conexion-2PU");
        ...
        response.sendRedirect("ok.jsp");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Visualizar1</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Visualizar1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        //} 
    }
