...
extern void Generate_AVL(AVLTREE *);
extern void Generate_BST(AVLTREE *);
extern void Destroy_avl(AVLTREE *);

// solo arbol binario
extern int Insert_bst(AVLTREE *,char,Nodoavl);
extern AVLTREE Delete_bst(AVLTREE ,char);
extern Nodoavl Transplant_bst(AVLTREE,Nodoavl,Nodoavl);
...
extern void Menu_operations_bst(AVLTREE *);
